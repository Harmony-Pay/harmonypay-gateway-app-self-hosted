...
export default async (req: NextApiRequest, res: NextApiResponse): Promise<NextApiResponse> => {
  ...
  _rates.LMA = 1/quotes_hrc20.LMA  //1/parseFloat(cryptocurrency_rates.harmony.usd)
  ...
  _rates.VINCI = 1/quotes_hrc20.VINCI //1/parseFloat('0.10'/*cryptocurrency_rates.harmony.usd*/)
  _rates.UST = 1/quotes_hrc20.UST  //1/parseFloat(cryptocurrency_rates.harmony.usd)
  _rates.LOOT = 1/quotes_hrc20.LOOT  //1/parseFloat(cryptocurrency_rates.harmony.usd)
  _rates.MOONI = 1/quotes_hrc20.MOONI  //1/parseFloat(cryptocurrency_rates.harmony.usd)
